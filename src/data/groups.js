...
export const GROUPS = [
  ...
  },
  {
    ...
    attribution:
      'Google Cloud publishes Google Threat Intelligence Group research under the Google Threat Intelligence brand; the pin uses Google\'s official Mountain View global headquarters as the organization origin.',
    sourceLabel: 'Google Cloud / Google',
  },
  {
    id: 'cisco-talos',
    name: 'Cisco Talos',
  ...
  },
  {
    ...
    scope: 'Global',
    aliases: [],
    tags: ['incident response', 'threat intelligence', 'consulting'],
    knownFor:
      'Responding to major intrusions around the world and publishing deeply influential threat intelligence, breach investigations, and attacker tradecraft analysis.',
    attribution:
      'Mandiant now operates within Google Cloud; this atlas uses Google\'s official Mountain View global headquarters as the current organization origin for the Mandiant brand and services.',
    sourceLabel: 'Google Cloud / Mandiant',
  },
  {
